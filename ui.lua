...
local RayfieldFolder = "717exe - Fish It"
...
local useMobileSizing = true
local useMobilePrompt = true
...
local function Hide(notify: boolean?)
	if MPrompt then
        MPrompt.Title.Text = "717exe - Fish it" -- 🟡 Ganti teks di tombol
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if not requestsDisabled then
		sendReport("window_created", '717exe - Fish it' or "Unknown")
	end
	local Passthrough = false
	Topbar.Title.Text = '717exe - Fish it'
	...
	if Settings.ShowText then
		MPrompt.Title.Text = '717exe - Fish it'
	end

	LoadingFrame.Version.TextTransparency = 1
	LoadingFrame.Title.Text = Settings.LoadingTitle or "717exe - Fish it"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or ""

	if Settings.LoadingTitle ~= "" then
		LoadingFrame.Version.Text = "717exe"
	end
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "717exe - Fish it",
					Content = "Join Discord: https://discord.gg/fB3UJPfMX4",
					Duration = 7,
					Image = 4370033185,
				})
			end
